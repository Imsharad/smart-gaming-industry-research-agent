...
Dynamically lists all available tools, their purposes, and parameter requirements.
...
included in the system prompts that need to output a TravelPlan data structure.
