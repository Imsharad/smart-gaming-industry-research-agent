...
<review_instructions>
  <evaluation_sequence>
    ...
    <loop_structure>For each criterion (1 through 5):
      ...
      5. Generate feedback/criteria_{N}.md with assessment
      6. Include ALL images from criteria{N}.md in feedback/criteria_{N}.md (MANDATORY)
  ...
  <feedback_format>
    ...
    <summary_file>Generate feedback/summary.md ONLY AFTER all 5 criteria have been evaluated</summary_file>
